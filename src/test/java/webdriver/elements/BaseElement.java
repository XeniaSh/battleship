...
public abstract class BaseElement extends BaseEntity {
	...
	protected BaseElement(String stringLocator, final String nameOfElement) {
		...
		name = nameOfElement;
	}   else if (stringLocator.contains(colon)){
			locator = stringToBy(stringLocator);
		} else {
	...
	/**
	 * Waits until required  message
	 * @param string  message
	 */
	public void waitUntilText(String string){
	    By byLocator = stringToBy(String.format(locator.toString(), string));
        WebElement webElement = (new WebDriverWait(browser.getDriver(), timeOut))
